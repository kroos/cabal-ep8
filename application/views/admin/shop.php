...
<div class="demo">
<p align="center"><?php echo anchor('shopadmin/add_item', 'Add Item', array('title' => 'Add Item')) ?></p></div>
<?php if ($query->num_rows() < 1): ?>
	<p>No item to sell yet</p>
<?php else: ?>
	...
	<?php foreach($query->result() as $r): ?>
		<tr>
			<td><img border="0" src="<?php echo $r->Image ?>"></td>
			<td>
				<table border="0" width="100%">
					<tr>
						<td><?php echo anchor('shopadmin/edit_item/'.$r->Id, 'Edit '.$r->Name, array('title' => 'Edit '.$r->Name)) ?></td>
					</tr>
					<tr>
						<td><?php echo $r->Description ?></td>
					</tr>
					<tr>
						<td><strong><?php echo $r->Alz ?> Alz</strong></td>
					</tr>
				</table>
			</td>
			...
			<?php else: ?>
				<td><strong><?php echo $r->Available ?> Units</strong></td>
			<?php endif ?>
			<td><?php echo anchor('shopadmin/del_item/'.$r->Id, 'Delete', array('title' => 'Delete '.$r->Name)) ?></td>
		</tr>
	<?php endforeach ?>
	</table>
	</div>
