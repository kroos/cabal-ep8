...
<p>Click on <strong>CheckOut</strong> once you are done</p>
...
<?php else: ?>
	...
	<tr>
		...
		<th style="text-align:right">Item Price (Alz)</th>
	...
	<tr>
		<td><?php echo form_input($i.'[qty]', $items['qty'], 'id="spinner"').form_error($i.'[qty]')?></td>
...
<p><div class="demo"><?php echo form_submit('update', 'Update Your Cart').anchor('shop/checkout/'.$this->uri->segment(3, 0).'/'.$this->uri->segment(4, 0), 'CheckOut')?></div></p>
<?php endif ?>
